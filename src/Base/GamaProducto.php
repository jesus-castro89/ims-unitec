...
/**
 * Base class that represents a row from the 'gama_producto' table.
 *
 *
 *
 * @package    propel.generator.App.Base
 */
abstract class GamaProducto implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\App\\Map\\GamaProductoTableMap';
    ...
    /**
     * The value for the descripcion_texto field.
     *
     * @var        string|null
     */
    protected $descripcion_texto;

    /**
     * The value for the descripcion_html field.
     *
     * @var        string|null
     */
    protected $descripcion_html;
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildProducto> Collection to store aggregation of ChildProducto objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildProducto>
     */
    protected $productosScheduledForDeletion = null;

    /**
     * Initializes internal state of App\Base\GamaProducto object.
     */
    ...
    /**
     * Compares this with another <code>GamaProducto</code> instance.  If
     * <code>obj</code> is an instance of <code>GamaProducto</code>, delegates to
     * <code>equals(GamaProducto)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [descripcion_texto] column value.
     *
     * @return string|null
     */
    public function getDescripcionTexto()
    {
        return $this->descripcion_texto;
    }

    /**
     * Get the [descripcion_html] column value.
     *
     * @return string|null
     */
    public function getDescripcionHtml()
    {
        return $this->descripcion_html;
    }
    ...
    public function setGama($v)
    {
        ...
        if ($this->gama !== $v) {
            $this->gama = $v;
            $this->modifiedColumns[GamaProductoTableMap::COL_GAMA] = true;
        }
    ...
    /**
     * Set the value of [descripcion_texto] column.
     *
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setDescripcionTexto($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->descripcion_texto !== $v) {
            $this->descripcion_texto = $v;
            $this->modifiedColumns[GamaProductoTableMap::COL_DESCRIPCION_TEXTO] = true;
        }
    ...
    /**
     * Set the value of [descripcion_html] column.
     *
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setDescripcionHtml($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->descripcion_html !== $v) {
            $this->descripcion_html = $v;
            $this->modifiedColumns[GamaProductoTableMap::COL_DESCRIPCION_HTML] = true;
        }
    ...
    public function setImagen($v)
    {
        ...
        if ($this->imagen !== $v) {
            $this->imagen = $v;
            $this->modifiedColumns[GamaProductoTableMap::COL_IMAGEN] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GamaProductoTableMap::translateFieldName('Gama', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gama = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GamaProductoTableMap::translateFieldName('DescripcionTexto', TableMap::TYPE_PHPNAME, $indexType)];
            $this->descripcion_texto = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : GamaProductoTableMap::translateFieldName('DescripcionHtml', TableMap::TYPE_PHPNAME, $indexType)];
            $this->descripcion_html = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : GamaProductoTableMap::translateFieldName('Imagen', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = GamaProductoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\GamaProducto'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildGamaProductoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see GamaProducto::setDeleted()
     * @see GamaProducto::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildGamaProductoQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GamaProductoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(GamaProductoTableMap::COL_GAMA)) {
            $modifiedColumns[':p' . $index++]  = 'gama';
        }
        if ($this->isColumnModified(GamaProductoTableMap::COL_DESCRIPCION_TEXTO)) {
            $modifiedColumns[':p' . $index++]  = 'descripcion_texto';
        }
        if ($this->isColumnModified(GamaProductoTableMap::COL_DESCRIPCION_HTML)) {
            $modifiedColumns[':p' . $index++]  = 'descripcion_html';
        }
        if ($this->isColumnModified(GamaProductoTableMap::COL_IMAGEN)) {
            $modifiedColumns[':p' . $index++]  = 'imagen';
        }

        $sql = sprintf(
            'INSERT INTO gama_producto (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'descripcion_texto':
                        $stmt->bindValue($identifier, $this->descripcion_texto, PDO::PARAM_STR);

                        break;
                    case 'descripcion_html':
                        $stmt->bindValue($identifier, $this->descripcion_html, PDO::PARAM_STR);
    ...
    {
        $pos = GamaProductoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            ...
            case 1:
                return $this->getDescripcionTexto();

            case 2:
                return $this->getDescripcionHtml();
    ...
    {
        if (isset($alreadyDumpedObjects['GamaProducto'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['GamaProducto'][$this->hashCode()] = true;
        $keys = GamaProductoTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getGama(),
            $keys[1] => $this->getDescripcionTexto(),
            $keys[2] => $this->getDescripcionHtml(),
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setDescripcionTexto($value);
                break;
            case 2:
                $this->setDescripcionHtml($value);
                break;
            case 3:
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setGama($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setDescripcionTexto($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setDescripcionHtml($arr[$keys[2]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(GamaProductoTableMap::COL_GAMA)) {
            $criteria->add(GamaProductoTableMap::COL_GAMA, $this->gama);
        }
        if ($this->isColumnModified(GamaProductoTableMap::COL_DESCRIPCION_TEXTO)) {
            $criteria->add(GamaProductoTableMap::COL_DESCRIPCION_TEXTO, $this->descripcion_texto);
        }
        if ($this->isColumnModified(GamaProductoTableMap::COL_DESCRIPCION_HTML)) {
            $criteria->add(GamaProductoTableMap::COL_DESCRIPCION_HTML, $this->descripcion_html);
        }
        if ($this->isColumnModified(GamaProductoTableMap::COL_IMAGEN)) {
            $criteria->add(GamaProductoTableMap::COL_IMAGEN, $this->imagen);
        }
    ...
    {
        $criteria = ChildGamaProductoQuery::create();
        $criteria->add(GamaProductoTableMap::COL_GAMA, $this->gama);
    ...
    /**
     * Generic method to set the primary key (gama column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of \App\GamaProducto (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setDescripcionTexto($this->getDescripcionTexto());
        $copyObj->setDescripcionHtml($this->getDescripcionHtml());
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\GamaProducto Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * @return void
     */
    public function resetPartialProductos($v = true): void
    {
     ...
     * @return void
     */
    public function initProductos(bool $overrideExisting = true): void
    {
        ...
        $this->collProductos->setModel('\App\Producto');
    }
     ...
     * If this ChildGamaProducto is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildProducto[] List of ChildProducto objects
     * @phpstan-return ObjectCollection&\Traversable<ChildProducto> List of ChildProducto objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collProductos || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collProductos) {
                    ...
                    $collProductos = new $collectionClassName;
                    $collProductos->setModel('\App\Producto');

                    return $collProductos;
                }
            } else {
                $collProductos = ChildProductoQuery::create(null, $criteria)
                    ->filterByGamaProducto($this)
                    ->find($con);
    ...
    public function setProductos(Collection $productos, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($productosToDelete as $productoRemoved) {
            $productoRemoved->setGamaProducto(null);
        }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countProductos(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collProductosPartial && !$this->isNew();
        if (null === $this->collProductos || null !== $criteria || $partial) {
     ...
     */
    protected function doAddProducto(ChildProducto $producto): void
    {
    ...
    {
        return (string) $this->exportTo(GamaProductoTableMap::DEFAULT_STRING_FORMAT);
    }
