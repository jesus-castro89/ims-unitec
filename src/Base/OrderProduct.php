...
abstract class OrderProduct implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\App\\Map\\OrderProductTableMap';
     ...
     * Orden de la cual es parte la relación
     * @var        string
     */
    protected $order_id;
     ...
     * Producto del cual es parte la relación
     * @var        string
     */
     ...
     * Cantidad de productos agregados a la orden
     * @var        int
     */
    protected $quantity;
     ...
     * Porcentaje de descuento entendiendo que 0.1 es equivalente a 10% de decuento
    ...
    /**
     * Initializes internal state of App\Base\OrderProduct object.
     * @see applyDefaults()
     */
    ...
    public function setOrderId($v)
    {
        ...
        if ($this->aOderDetail !== null && $this->aOderDetail->getId() !== $v) {
            $this->aOderDetail = null;
        }
    ...
    public function setDiscount($v)
    {
        ...
        if ($this->discount !== $v) {
            $this->discount = $v;
            $this->modifiedColumns[OrderProductTableMap::COL_DISCOUNT] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OrderProductTableMap::translateFieldName('Discount', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\OrderProduct'), 0, $e);
        }
    }
    ...
    {
        if ($this->aOderDetail !== null && $this->order_id !== $this->aOderDetail->getId()) {
            $this->aOderDetail = null;
        }
    ...
    protected function doSave(ConnectionInterface $con): int
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aOderDetail !== null) {
                if ($this->aOderDetail->isModified() || $this->aOderDetail->isNew()) {
                    $affectedRows += $this->aOderDetail->save($con);
                }
                $this->setOderDetail($this->aOderDetail);
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(OrderProductTableMap::COL_DISCOUNT)) {
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aOderDetail) {
                ...
                $result[$key] = $this->aOderDetail->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(OrderProductTableMap::COL_DISCOUNT)) {
            $criteria->add(OrderProductTableMap::COL_DISCOUNT, $this->discount);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \App\OrderProduct (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\OrderProduct Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildOderDetail object.
     *
     * @param ChildOderDetail $v
     * @return $this The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setOderDetail(ChildOderDetail $v = null)
    {
        if ($v === null) {
        ...
        // If this object has already been added to the ChildOderDetail object, it will not be re-added.
        if ($v !== null) {
    ...
    /**
     * Get the associated ChildOderDetail object
     *
     * @param ConnectionInterface $con Optional Connection object.
     * @return ChildOderDetail The associated ChildOderDetail object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getOderDetail(?ConnectionInterface $con = null)
    {
        if ($this->aOderDetail === null && (($this->order_id !== "" && $this->order_id !== null))) {
            $this->aOderDetail = ChildOderDetailQuery::create()->findPk($this->order_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOderDetail->addOrderProducts($this);
             */
        }

        return $this->aOderDetail;
    }
    ...
    {
        if (null !== $this->aOderDetail) {
            $this->aOderDetail->removeOrderProduct($this);
        }
        if (null !== $this->aProduct) {
