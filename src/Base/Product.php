...
abstract class Product implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\App\\Map\\ProductTableMap';
    ...
    /**
     * Initializes internal state of App\Base\Product object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Product'), 0, $e);
        }
    }
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aCategoryRelatedByCategoryId) {
                ...
                $result[$key] = $this->aCategoryRelatedByCategoryId->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aCategoryRelatedByCategoryId) {
     ...
     * objects.
     *
     * @param object $copyObj An object of \App\Product (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Product Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function setCategoryRelatedByCategoryId(ChildCategory $v = null)
    {
        ...
        if ($v !== null) {
            $v->addProductRelatedByCategoryId($this);
        }
    ...
    {
        if ($this->aCategoryRelatedByCategoryId === null && (($this->category_id !== "" && $this->category_id !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCategoryRelatedByCategoryId->addProductsRelatedByCategoryId($this);
             */
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildOrderProduct}> List of ChildOrderProduct objects
     */
    public function getOrderProductsJoinOderDetail(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOrderProductQuery::create(null, $criteria);
        $query->joinWith('OderDetail', $joinBehavior);
    ...
    {
        if (null !== $this->aCategoryRelatedByCategoryId) {
            $this->aCategoryRelatedByCategoryId->removeProductRelatedByCategoryId($this);
        }
        if (null !== $this->aCategoryRelatedByCategoryId) {
            $this->aCategoryRelatedByCategoryId->removeProductRelatedByCategoryId($this);
        }
