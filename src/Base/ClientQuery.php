 ...
 * @method     ChildClientQuery orderByZipCode($order = Criteria::ASC) Order by the zip_code column
 *
 ...
 * @method     ChildClientQuery groupByZipCode() Group by the zip_code column
 *
 ...
 *
 * @method     ChildClientQuery leftJoinOderDetail($relationAlias = null) Adds a LEFT JOIN clause to the query using the OderDetail relation
 * @method     ChildClientQuery rightJoinOderDetail($relationAlias = null) Adds a RIGHT JOIN clause to the query using the OderDetail relation
 * @method     ChildClientQuery innerJoinOderDetail($relationAlias = null) Adds a INNER JOIN clause to the query using the OderDetail relation
 *
 * @method     ChildClientQuery joinWithOderDetail($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the OderDetail relation
 *
 * @method     ChildClientQuery leftJoinWithOderDetail() Adds a LEFT JOIN clause and with to the query using the OderDetail relation
 * @method     ChildClientQuery rightJoinWithOderDetail() Adds a RIGHT JOIN clause and with to the query using the OderDetail relation
 * @method     ChildClientQuery innerJoinWithOderDetail() Adds a INNER JOIN clause and with to the query using the OderDetail relation
 *
 * @method     \App\OderDetailQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildClient|null findOne(?ConnectionInterface $con = null) Return the first ChildClient matching the query
 * @method     ChildClient findOneOrCreate(?ConnectionInterface $con = null) Return the first ChildClient matching the query, or a new ChildClient object populated from the query conditions when nonmatch is found
 *
 * @method     ChildClient|null findOneById(string $id) Return the first ChildClient filtered by the id column
 * @method     ChildClient|null findOneByName(string $name) Return the first ChildClient filtered by the name column
 * @method     ChildClient|null findOneByLastName(string $last_name) Return the first ChildClient filtered by the last_name column
 * @method     ChildClient|null findOneByAddress(string $address) Return the first ChildClient filtered by the address column
 * @method     ChildClient|null findOneByZipCode(int $zip_code) Return the first ChildClient filtered by the zip_code column
 *
 ...
 *
 * @method     ChildClient requireOneById(string $id) Return the first ChildClient filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildClient requireOneByZipCode(int $zip_code) Return the first ChildClient filtered by the zip_code column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 *
 * @method     ChildClient[]|Collection findById(string|array<string> $id) Return ChildClient objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildClient> findById(string|array<string> $id) Return ChildClient objects filtered by the id column
 * @method     ChildClient[]|Collection findByName(string|array<string> $name) Return ChildClient objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildClient> findByName(string|array<string> $name) Return ChildClient objects filtered by the name column
 * @method     ChildClient[]|Collection findByLastName(string|array<string> $last_name) Return ChildClient objects filtered by the last_name column
 * @psalm-method Collection&\Traversable<ChildClient> findByLastName(string|array<string> $last_name) Return ChildClient objects filtered by the last_name column
 * @method     ChildClient[]|Collection findByAddress(string|array<string> $address) Return ChildClient objects filtered by the address column
 * @psalm-method Collection&\Traversable<ChildClient> findByAddress(string|array<string> $address) Return ChildClient objects filtered by the address column
 * @method     ChildClient[]|Collection findByZipCode(int|array<int> $zip_code) Return ChildClient objects filtered by the zip_code column
 * @psalm-method Collection&\Traversable<ChildClient> findByZipCode(int|array<int> $zip_code) Return ChildClient objects filtered by the zip_code column
 *
...
abstract class ClientQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Base\ClientQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\Client', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, last_name, address, zip_code FROM client WHERE id = :p0';
        try {
    ...
    public function filterByName($name = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ClientTableMap::COL_NAME, $name, $comparison);
    ...
    public function filterByLastName($lastName = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ClientTableMap::COL_LAST_NAME, $lastName, $comparison);
    ...
    public function filterByAddress($address = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ClientTableMap::COL_ADDRESS, $address, $comparison);
    ...
    public function filterByZipCode($zipCode = null, ?string $comparison = null)
    {
        if (is_array($zipCode)) {
            ...
            if (isset($zipCode['min'])) {
                $this->addUsingAlias(ClientTableMap::COL_ZIP_CODE, $zipCode['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($zipCode['max'])) {
                $this->addUsingAlias(ClientTableMap::COL_ZIP_CODE, $zipCode['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        $this->addUsingAlias(ClientTableMap::COL_ZIP_CODE, $zipCode, $comparison);
     ...
     *
     * @param \App\OderDetail|ObjectCollection $oderDetail the related object to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByOderDetail($oderDetail, ?string $comparison = null)
    {
        if ($oderDetail instanceof \App\OderDetail) {
            $this
                ->addUsingAlias(ClientTableMap::COL_ID, $oderDetail->getClientId(), $comparison);

            return $this;
        } elseif ($oderDetail instanceof ObjectCollection) {
            $this
                ->useOderDetailQuery()
                ->filterByPrimaryKeys($oderDetail->getPrimaryKeys())
                ->endUse();
