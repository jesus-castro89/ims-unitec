...
/**
 * Base class that represents a row from the 'oficina' table.
 *
 *
 *
 * @package    propel.generator.App.Base
 */
abstract class Oficina implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\App\\Map\\OficinaTableMap';
    ...
    /**
     * Initializes internal state of App\Base\Oficina object.
     */
    ...
    /**
     * Compares this with another <code>Oficina</code> instance.  If
     * <code>obj</code> is an instance of <code>Oficina</code>, delegates to
     * <code>equals(Oficina)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setCodigoOficina($v)
    {
        ...
        if ($this->codigo_oficina !== $v) {
            ...
            $this->modifiedColumns[OficinaTableMap::COL_CODIGO_OFICINA] = true;
        }
    ...
    public function setCiudad($v)
    {
        ...
        if ($this->ciudad !== $v) {
            $this->ciudad = $v;
            $this->modifiedColumns[OficinaTableMap::COL_CIUDAD] = true;
        }
    ...
    public function setPais($v)
    {
        ...
        if ($this->pais !== $v) {
            $this->pais = $v;
            $this->modifiedColumns[OficinaTableMap::COL_PAIS] = true;
        }
    ...
    public function setRegion($v)
    {
        ...
        if ($this->region !== $v) {
            $this->region = $v;
            $this->modifiedColumns[OficinaTableMap::COL_REGION] = true;
        }
    ...
    public function setCodigoPostal($v)
    {
        ...
        if ($this->codigo_postal !== $v) {
            ...
            $this->modifiedColumns[OficinaTableMap::COL_CODIGO_POSTAL] = true;
        }
    ...
    public function setTelefono($v)
    {
        ...
        if ($this->telefono !== $v) {
            $this->telefono = $v;
            $this->modifiedColumns[OficinaTableMap::COL_TELEFONO] = true;
        }
    ...
    public function setLineaDireccion1($v)
    {
        ...
        if ($this->linea_direccion1 !== $v) {
            ...
            $this->modifiedColumns[OficinaTableMap::COL_LINEA_DIRECCION1] = true;
        }
    ...
    public function setLineaDireccion2($v)
    {
        ...
        if ($this->linea_direccion2 !== $v) {
            ...
            $this->modifiedColumns[OficinaTableMap::COL_LINEA_DIRECCION2] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OficinaTableMap::translateFieldName('CodigoOficina', TableMap::TYPE_PHPNAME, $indexType)];
            $this->codigo_oficina = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OficinaTableMap::translateFieldName('Ciudad', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ciudad = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OficinaTableMap::translateFieldName('Pais', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pais = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OficinaTableMap::translateFieldName('Region', TableMap::TYPE_PHPNAME, $indexType)];
            $this->region = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OficinaTableMap::translateFieldName('CodigoPostal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->codigo_postal = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : OficinaTableMap::translateFieldName('Telefono', TableMap::TYPE_PHPNAME, $indexType)];
            $this->telefono = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : OficinaTableMap::translateFieldName('LineaDireccion1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->linea_direccion1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : OficinaTableMap::translateFieldName('LineaDireccion2', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = OficinaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Oficina'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildOficinaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see Oficina::setDeleted()
     * @see Oficina::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOficinaQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OficinaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(OficinaTableMap::COL_CODIGO_OFICINA)) {
            $modifiedColumns[':p' . $index++]  = 'codigo_oficina';
        }
        if ($this->isColumnModified(OficinaTableMap::COL_CIUDAD)) {
            $modifiedColumns[':p' . $index++]  = 'ciudad';
        }
        if ($this->isColumnModified(OficinaTableMap::COL_PAIS)) {
            $modifiedColumns[':p' . $index++]  = 'pais';
        }
        if ($this->isColumnModified(OficinaTableMap::COL_REGION)) {
            $modifiedColumns[':p' . $index++]  = 'region';
        }
        if ($this->isColumnModified(OficinaTableMap::COL_CODIGO_POSTAL)) {
            $modifiedColumns[':p' . $index++]  = 'codigo_postal';
        }
        if ($this->isColumnModified(OficinaTableMap::COL_TELEFONO)) {
            $modifiedColumns[':p' . $index++]  = 'telefono';
        }
        if ($this->isColumnModified(OficinaTableMap::COL_LINEA_DIRECCION1)) {
            $modifiedColumns[':p' . $index++]  = 'linea_direccion1';
        }
        if ($this->isColumnModified(OficinaTableMap::COL_LINEA_DIRECCION2)) {
    ...
    {
        $pos = OficinaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Oficina'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['Oficina'][$this->hashCode()] = true;
        $keys = OficinaTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getCodigoOficina(),
            $keys[1] => $this->getCiudad(),
            $keys[2] => $this->getPais(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->collEmpleados) {
                ...
                $result[$key] = $this->collEmpleados->toArray(null, false, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setCodigoOficina($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setCiudad($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setPais($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setRegion($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setCodigoPostal($arr[$keys[4]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(OficinaTableMap::COL_CODIGO_OFICINA)) {
            $criteria->add(OficinaTableMap::COL_CODIGO_OFICINA, $this->codigo_oficina);
        }
        if ($this->isColumnModified(OficinaTableMap::COL_CIUDAD)) {
            $criteria->add(OficinaTableMap::COL_CIUDAD, $this->ciudad);
        }
        if ($this->isColumnModified(OficinaTableMap::COL_PAIS)) {
            $criteria->add(OficinaTableMap::COL_PAIS, $this->pais);
        }
        if ($this->isColumnModified(OficinaTableMap::COL_REGION)) {
            $criteria->add(OficinaTableMap::COL_REGION, $this->region);
        }
        if ($this->isColumnModified(OficinaTableMap::COL_CODIGO_POSTAL)) {
            $criteria->add(OficinaTableMap::COL_CODIGO_POSTAL, $this->codigo_postal);
        }
        if ($this->isColumnModified(OficinaTableMap::COL_TELEFONO)) {
            $criteria->add(OficinaTableMap::COL_TELEFONO, $this->telefono);
        }
        if ($this->isColumnModified(OficinaTableMap::COL_LINEA_DIRECCION1)) {
            $criteria->add(OficinaTableMap::COL_LINEA_DIRECCION1, $this->linea_direccion1);
        }
        if ($this->isColumnModified(OficinaTableMap::COL_LINEA_DIRECCION2)) {
            $criteria->add(OficinaTableMap::COL_LINEA_DIRECCION2, $this->linea_direccion2);
        }
    ...
    {
        $criteria = ChildOficinaQuery::create();
        $criteria->add(OficinaTableMap::COL_CODIGO_OFICINA, $this->codigo_oficina);
    ...
    {
        $validPk = null !== $this->getCodigoOficina();
    ...
    /**
     * Generic method to set the primary key (codigo_oficina column).
     *
    ...
    {
        return null === $this->getCodigoOficina();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \App\Oficina (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Oficina Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * @return void
     */
    public function resetPartialEmpleados($v = true): void
    {
     ...
     * @return void
     */
    public function initEmpleados(bool $overrideExisting = true): void
    {
        ...
        $this->collEmpleados = new $collectionClassName;
        $this->collEmpleados->setModel('\App\Empleado');
    }
     ...
     * If this ChildOficina is new, it will return
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getEmpleados(?Criteria $criteria = null, ?ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collEmpleados || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collEmpleados) {
                    ...
                    $collEmpleados = new $collectionClassName;
                    $collEmpleados->setModel('\App\Empleado');

                    return $collEmpleados;
                }
            } else {
                $collEmpleados = ChildEmpleadoQuery::create(null, $criteria)
                    ->filterByOficina($this)
                    ->find($con);
     ...
     *
     * @param Collection $empleados A Propel collection.
     * @param ConnectionInterface $con Optional connection object
     * @return $this The current object (for fluent API support)
     */
    public function setEmpleados(Collection $empleados, ?ConnectionInterface $con = null)
    {
        /** @var ChildEmpleado[] $empleadosToDelete */
        ...
        foreach ($empleadosToDelete as $empleadoRemoved) {
            $empleadoRemoved->setOficina(null);
        }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countEmpleados(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collEmpleadosPartial && !$this->isNew();
        if (null === $this->collEmpleados || null !== $criteria || $partial) {
     ...
     * @return $this The current object (for fluent API support)
     */
    public function addEmpleado(ChildEmpleado $l)
    {
        if ($this->collEmpleados === null) {
            $this->initEmpleados();
            $this->collEmpleadosPartial = true;
        ...
        if (!$this->collEmpleados->contains($l)) {
    ...
    /**
     * @param ChildEmpleado $empleado The ChildEmpleado object to add.
     */
    protected function doAddEmpleado(ChildEmpleado $empleado): void
    {
    ...
    /**
     * @param ChildEmpleado $empleado The ChildEmpleado object to remove.
     * @return $this The current object (for fluent API support)
     */
    public function removeEmpleado(ChildEmpleado $empleado)
    {
        if ($this->getEmpleados()->contains($empleado)) {
            $pos = $this->collEmpleados->search($empleado);
            $this->collEmpleados->remove($pos);
     ...
     * Otherwise if this Oficina is new, it will return
     * an empty collection; or if this Oficina has previously
     * been saved, it will retrieve related Empleados from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Oficina.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildEmpleado}> List of ChildEmpleado objects
     */
    public function getEmpleadosJoinEmpleadoRelatedByCodigoJefe(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildEmpleadoQuery::create(null, $criteria);
        $query->joinWith('EmpleadoRelatedByCodigoJefe', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(OficinaTableMap::DEFAULT_STRING_FORMAT);
    }
