 ...
 *
 * @method     ChildCategoryQuery leftJoinProductRelatedByCategoryId($relationAlias = null) Adds a LEFT JOIN clause to the query using the ProductRelatedByCategoryId relation
 * @method     ChildCategoryQuery rightJoinProductRelatedByCategoryId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ProductRelatedByCategoryId relation
 * @method     ChildCategoryQuery innerJoinProductRelatedByCategoryId($relationAlias = null) Adds a INNER JOIN clause to the query using the ProductRelatedByCategoryId relation
 *
 * @method     ChildCategoryQuery joinWithProductRelatedByCategoryId($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the ProductRelatedByCategoryId relation
 *
 * @method     ChildCategoryQuery leftJoinWithProductRelatedByCategoryId() Adds a LEFT JOIN clause and with to the query using the ProductRelatedByCategoryId relation
 * @method     ChildCategoryQuery rightJoinWithProductRelatedByCategoryId() Adds a RIGHT JOIN clause and with to the query using the ProductRelatedByCategoryId relation
 * @method     ChildCategoryQuery innerJoinWithProductRelatedByCategoryId() Adds a INNER JOIN clause and with to the query using the ProductRelatedByCategoryId relation
 *
 * @method     \App\ProductQuery|\App\ProductQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildCategory|null findOne(?ConnectionInterface $con = null) Return the first ChildCategory matching the query
 * @method     ChildCategory findOneOrCreate(?ConnectionInterface $con = null) Return the first ChildCategory matching the query, or a new ChildCategory object populated from the query conditions when nonmatch is found
 *
 ...
 *
 * @method     ChildCategory[]|Collection findById(string|array<string> $id) Return ChildCategory objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildCategory> findById(string|array<string> $id) Return ChildCategory objects filtered by the id column
...
abstract class CategoryQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Base\CategoryQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\Category', $modelAlias = null)
    {
     ...
     *
     * @param \App\Product|ObjectCollection $product the related object to use as filter
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByProductRelatedByCategoryId($product, ?string $comparison = null)
    {
        if ($product instanceof \App\Product) {
            ...
            $this
                ->useProductRelatedByCategoryIdQuery()
                ->filterByPrimaryKeys($product->getPrimaryKeys())
                ->endUse();

            return $this;
        } else {
            throw new PropelException('filterByProductRelatedByCategoryId() only accepts arguments of type \App\Product or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the ProductRelatedByCategoryId relation
     *
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinProductRelatedByCategoryId(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('ProductRelatedByCategoryId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'ProductRelatedByCategoryId');
        }
    ...
    /**
     * Use the ProductRelatedByCategoryId relation Product object
     *
     * @see useQuery()
     *
     ...
     */
    public function useProductRelatedByCategoryIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinProductRelatedByCategoryId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'ProductRelatedByCategoryId', '\App\ProductQuery');
    }
     ...
     * @return $this
     */
    public function withProductRelatedByCategoryIdQuery(
        callable $callable,
        string $relationAlias = null,
        ?string $joinType = Criteria::INNER_JOIN
    ) {
        $relatedQuery = $this->useProductRelatedByCategoryIdQuery(
            $relationAlias,
            $joinType
        );
    ...
    /**
     * Use the ProductRelatedByCategoryId relation to the Product table for an EXISTS query.
     *
     ...
     */
    public function useProductRelatedByCategoryIdExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \App\ProductQuery */
        $q = $this->useExistsQuery('ProductRelatedByCategoryId', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }

    /**
     * Use the ProductRelatedByCategoryId relation to the Product table for a NOT EXISTS query.
     *
     * @see useProductRelatedByCategoryIdExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     ...
     */
    public function useProductRelatedByCategoryIdNotExistsQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \App\ProductQuery */
        $q = $this->useExistsQuery('ProductRelatedByCategoryId', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the ProductRelatedByCategoryId relation to the Product table for an IN query.
     *
     ...
     */
    public function useInProductRelatedByCategoryIdQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \App\ProductQuery */
        $q = $this->useInQuery('ProductRelatedByCategoryId', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the ProductRelatedByCategoryId relation to the Product table for a NOT IN query.
     *
     * @see useProductRelatedByCategoryIdInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     */
    public function useNotInProductRelatedByCategoryIdQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \App\ProductQuery */
        $q = $this->useInQuery('ProductRelatedByCategoryId', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
