...
class ProductTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'App.Map.ProductTableMap';
     ...
     */
    public const OM_CLASS = '\\App\\Product';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'App.Product';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Name', 'Price', 'CategoryId', ],
        self::TYPE_CAMELNAME     => ['id', 'name', 'price', 'categoryId', ],
        self::TYPE_COLNAME       => [ProductTableMap::COL_ID, ProductTableMap::COL_NAME, ProductTableMap::COL_PRICE, ProductTableMap::COL_CATEGORY_ID, ],
        self::TYPE_FIELDNAME     => ['id', 'name', 'price', 'category_id', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Name' => 1, 'Price' => 2, 'CategoryId' => 3, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'name' => 1, 'price' => 2, 'categoryId' => 3, ],
        self::TYPE_COLNAME       => [ProductTableMap::COL_ID => 0, ProductTableMap::COL_NAME => 1, ProductTableMap::COL_PRICE => 2, ProductTableMap::COL_CATEGORY_ID => 3, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'name' => 1, 'price' => 2, 'category_id' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\App\\Product');
        $this->setPackage('App');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('id', 'Id', 'VARCHAR', true, 36, null);
        $this->addColumn('name', 'Name', 'VARCHAR', true, 140, null);
        $this->addColumn('price', 'Price', 'DOUBLE', true, 5, null);
        $this->addForeignKey('category_id', 'CategoryId', 'VARCHAR', 'category', 'id', true, 36, null);
        $this->addForeignKey('category_id', 'CategoryId', 'VARCHAR', 'category', 'id', true, 36, null);
    }
    ...
    {
        $this->addRelation('CategoryRelatedByCategoryId', '\\App\\Category', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':category_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Product) { // it's a model object
