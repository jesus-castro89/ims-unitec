...
class ClientTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'App.Map.ClientTableMap';
     ...
     */
    public const OM_CLASS = '\\App\\Client';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'App.Client';
     ...
     */
    public const COL_NAME = 'client.name';

    /**
     * the column name for the last_name field
     */
    public const COL_LAST_NAME = 'client.last_name';

    /**
     * the column name for the address field
     */
    public const COL_ADDRESS = 'client.address';

    /**
     * the column name for the zip_code field
     */
    public const COL_ZIP_CODE = 'client.zip_code';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Name', 'LastName', 'Address', 'ZipCode', ],
        self::TYPE_CAMELNAME     => ['id', 'name', 'lastName', 'address', 'zipCode', ],
        self::TYPE_COLNAME       => [ClientTableMap::COL_ID, ClientTableMap::COL_NAME, ClientTableMap::COL_LAST_NAME, ClientTableMap::COL_ADDRESS, ClientTableMap::COL_ZIP_CODE, ],
        self::TYPE_FIELDNAME     => ['id', 'name', 'last_name', 'address', 'zip_code', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Name' => 1, 'LastName' => 2, 'Address' => 3, 'ZipCode' => 4, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'name' => 1, 'lastName' => 2, 'address' => 3, 'zipCode' => 4, ],
        self::TYPE_COLNAME       => [ClientTableMap::COL_ID => 0, ClientTableMap::COL_NAME => 1, ClientTableMap::COL_LAST_NAME => 2, ClientTableMap::COL_ADDRESS => 3, ClientTableMap::COL_ZIP_CODE => 4, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'name' => 1, 'last_name' => 2, 'address' => 3, 'zip_code' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'name' => 'NAME',
        'client.name' => 'NAME',
        'ClientTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'LastName' => 'LAST_NAME',
        'Client.LastName' => 'LAST_NAME',
        'lastName' => 'LAST_NAME',
        'client.lastName' => 'LAST_NAME',
        'ClientTableMap::COL_LAST_NAME' => 'LAST_NAME',
        ...
        'address' => 'ADDRESS',
        'client.address' => 'ADDRESS',
        'ClientTableMap::COL_ADDRESS' => 'ADDRESS',
        'COL_ADDRESS' => 'ADDRESS',
        'ZipCode' => 'ZIP_CODE',
        'Client.ZipCode' => 'ZIP_CODE',
        'zipCode' => 'ZIP_CODE',
        'client.zipCode' => 'ZIP_CODE',
        'ClientTableMap::COL_ZIP_CODE' => 'ZIP_CODE',
    ...
    public function initialize(): void
    {
        ...
        $this->addColumn('last_name', 'LastName', 'VARCHAR', true, 140, null);
    ...
    {
        $this->addRelation('OderDetail', '\\App\\OderDetail', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':client_id',
    1 => ':id',
  ),
), null, null, 'OderDetails', false);
    }
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ClientTableMap::COL_ZIP_CODE);
        } else {
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(ClientTableMap::COL_NAME);
            $criteria->removeSelectColumn(ClientTableMap::COL_LAST_NAME);
            $criteria->removeSelectColumn(ClientTableMap::COL_ADDRESS);
            $criteria->removeSelectColumn(ClientTableMap::COL_ZIP_CODE);
        } else {
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Client) { // it's a model object
