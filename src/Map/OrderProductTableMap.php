...
class OrderProductTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'App.Map.OrderProductTableMap';
     ...
     */
    public const OM_CLASS = '\\App\\OrderProduct';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'App.OrderProduct';
     ...
     */
    public const COL_ID = 'order_product.id';
     ...
     */
    public const COL_QUANTITY = 'order_product.quantity';

    /**
     * the column name for the discount field
     */
    public const COL_DISCOUNT = 'order_product.discount';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'OrderId', 'ProductId', 'Quantity', 'Discount', ],
        self::TYPE_CAMELNAME     => ['id', 'orderId', 'productId', 'quantity', 'discount', ],
        self::TYPE_COLNAME       => [OrderProductTableMap::COL_ID, OrderProductTableMap::COL_ORDER_ID, OrderProductTableMap::COL_PRODUCT_ID, OrderProductTableMap::COL_QUANTITY, OrderProductTableMap::COL_DISCOUNT, ],
        self::TYPE_FIELDNAME     => ['id', 'order_id', 'product_id', 'quantity', 'discount', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'OrderId' => 1, 'ProductId' => 2, 'Quantity' => 3, 'Discount' => 4, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'orderId' => 1, 'productId' => 2, 'quantity' => 3, 'discount' => 4, ],
        self::TYPE_COLNAME       => [OrderProductTableMap::COL_ID => 0, OrderProductTableMap::COL_ORDER_ID => 1, OrderProductTableMap::COL_PRODUCT_ID => 2, OrderProductTableMap::COL_QUANTITY => 3, OrderProductTableMap::COL_DISCOUNT => 4, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'order_id' => 1, 'product_id' => 2, 'quantity' => 3, 'discount' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'discount' => 'DISCOUNT',
        'orderProduct.discount' => 'DISCOUNT',
        'OrderProductTableMap::COL_DISCOUNT' => 'DISCOUNT',
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\App\\OrderProduct');
        $this->setPackage('App');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('id', 'Id', 'VARCHAR', true, 36, null);
        $this->addForeignKey('order_id', 'OrderId', 'VARCHAR', 'oder_detail', 'id', true, 36, null);
        $this->addForeignKey('product_id', 'ProductId', 'VARCHAR', 'product', 'id', true, 36, null);
        $this->addColumn('quantity', 'Quantity', 'INTEGER', true, 10, null);
        $this->addColumn('discount', 'Discount', 'DOUBLE', true, 3, 0.00);
    }
    ...
    {
        $this->addRelation('OderDetail', '\\App\\OderDetail', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':order_id',
    1 => ':id',
        ...
        $this->addRelation('Product', '\\App\\Product', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':product_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OrderProductTableMap::COL_DISCOUNT);
        } else {
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(OrderProductTableMap::COL_DISCOUNT);
        } else {
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\OrderProduct) { // it's a model object
